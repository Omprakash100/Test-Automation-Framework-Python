...
class TestHome:
    ...
    def test_fetch_top5_stocks(self, shared_top5_stocks, home_page):
        ...
        logger.info(f"Top five stocks sorted manually {shared_top5_stocks}")
    ...
    def test_verify_top5_stocks(self, shared_top5_stocks, home_page):
        ...
        logger.info(f"Top five sorted automatically {top_five_stocks}")
        assert top_five_stocks.keys() == shared_top5_stocks.keys(), "The top5 stocks are not matching"